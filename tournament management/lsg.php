...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT $attributesList FROM ipl WHERE team_name = 'LSG'";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            echo "<h2>LSG Team Details</h2>";
            echo "<table>";
            ...
            echo "No data available for LSG team.";
        }
