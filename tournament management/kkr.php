...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT $attributesList FROM ipl WHERE team_name = 'KKR'";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            echo "<h2>KKR Team Details</h2>";
            echo "<table>";
            ...
            echo "No data available for KKR team.";
        }
